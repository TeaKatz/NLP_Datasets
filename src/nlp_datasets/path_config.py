...
REFINED_SNLI_TRAIN_DIR = SNLI_BASE_DIR + "/refined_snli_1.0_train.txt"
REFINED_SNLI_VAL_DIR = SNLI_BASE_DIR + "/refined_snli_1.0_dev.txt"
REFINED_SNLI_TEST_DIR = SNLI_BASE_DIR + "/refined_snli_1.0_test.txt"
# MultiNLI
...
REFINED_MNLI_TRAIN_DIR = MNLI_BASE_DIR + "/refined_multinli_1.0_train.txt"
REFINED_MNLI_VAL_DIR = MNLI_BASE_DIR + "/refined_multinli_1.0_dev_matched.txt"
REFINED_MNLI_TEST_DIR = MNLI_BASE_DIR + "/refined_multinli_1.0_dev_mismatched.txt"